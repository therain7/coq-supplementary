...
Proof.
  intros [n] [m] H1 H2.
  inversion H1 as [n' m' Hnm]; subst.
  inversion H2 as [m'' n'' Hmn]; subst.
  lia.
Qed.
...
Proof.
  intros [n] [m] Hle Hgt.
  inversion Hle as [n' m' Hnm]; subst.
  inversion Hgt as [n'' m'' Hnm']; subst.
  lia.
Qed.
...
Proof.
  intros id1 id2 H.
  destruct (gt_eq_gt_id_dec id1 id2) as [[H1|H1]|H1].
  - left. apply H1.
  - right. contradiction.
  - right. apply H1.
Qed.
...
Proof.
  intros [n] [m] H H1; inversion H; subst.
  inversion H1 as [n' m' H2]; subst; lia.
Qed.
